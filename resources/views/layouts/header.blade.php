...
<!-- Mirrored from regaltheme.com/tf/multi/cultura/cultura/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Jul 2018 12:23:11 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="col-xs-12">
                            <div class="d-flex justify-end">
                                <div class="logo mr-auto">
                                    <a href="index.html"><img src="{{asset('assets/img/logo.png')}}" alt="Cultura" /></a>
                                </div>
                                <!-- Static navbar -->
                                <nav class="mainmenu">
