                ...
                <div class="col-xs-12 col-sm-6 col-md-3 mobi-mb-50 tab-mb-50">
                    <div class="footer-widget address">
                        <div class="title mb-40">
                            <a href="index.html"><img src="{{asset('assets/img/white-logo.png')}}" alt="Cultura" /></a>
                        </div>
                        <ul>
                        ...
                        <ul>
                            <li>
                                <a class="pull-left" href="courses.html">
                                    <img src="{{asset('assets/img/footer/c1.png')}}" alt="Image" />
                                </a>
                            ...
                            <li>
                                <a class="pull-left" href="courses.html">
                                    <img src="{{asset('assets/img/footer/c2.png')}}" alt="Image" />
                                </a>
                                <div class="headline pl-15">
                                    <a href="courses.html">
...
<!-- Mirrored from regaltheme.com/tf/multi/cultura/cultura/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Jul 2018 12:24:04 GMT -->
</html>
